...
class stm32f1_port_b6 : public digitalport {
private:
...
public:
    ...
    void set(bool v) override { GPIOB_ODR->odr6 = v; }
    bool get()       override { return GPIOB_IDR->idr6; }
};


class stm32f1_port_b7 : public digitalport {
private:
    void mode_input(PIN_MODE mode, INPUT_MODE cnf) {
...
public:
    ...
    void set(bool v) override { GPIOB_ODR->odr7 = v; }
    bool get()       override { return GPIOB_IDR->idr7; }
};


class stm32f1_port_b8 : public digitalport {
private:
    void mode_input(PIN_MODE mode, INPUT_MODE cnf) {
...
public:
    ...
    void set(bool v) override { GPIOB_ODR->odr8 = v; }
    bool get()       override { return GPIOB_IDR->idr8; }
};

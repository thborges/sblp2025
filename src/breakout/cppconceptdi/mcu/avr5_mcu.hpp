...
template<
    digitalport dp_mosi = c_digitalport,
    digitalport dp_miso = c_digitalport,
    digitalport dp_sck = c_digitalport,
    digitalport dp_ss = c_digitalport>
class avr5_spi {
    dp_mosi& mosi;
    dp_miso& miso;
    dp_sck& sck;
...
class avr5_uart0 {
    mcu_impl& mmcu;
public:
    avr5_uart0(mcu_impl& mmcu) : mmcu(mmcu) {
